                  ...
                  <AnimatePresence>
                    {showDislikeOptions && (
                      <motion.div
                        ...
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: 4 }}
                        className="absolute bottom-full right-0 mb-2 rounded-lg border z-50 min-w-[180px] overflow-hidden py-1 shadow-lg"
                        style={{
                          background: theme.colors.surface,
                          borderColor: theme.colors.border,
                        }}
                        ...
                        {showCustomInput ? (
                          <div className="p-2 flex flex-col gap-2">
                            <textarea
                              ...
                              placeholder="Enter deviation notes..."
                              rows={2}
                              autoFocus
                              className="w-full text-xs p-2 rounded border focus:outline-none focus:ring-1 focus:ring-indigo-500 resize-none font-medium"
                              style={{
                                color: theme.colors.text,
                          ...
                          [
                            ...
                            "Breached response latency",
                            "Irrelevant answer matrix",
