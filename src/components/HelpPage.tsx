    ...
    >
      <div className="max-w-6xl mx-auto space-y-8 pb-12">
        ...
        >
          ...
          >
            Search our user manuals, diagnostic steps, database connection setup
            instructions, and conversational interface guides.
          </p>
        ...
        {filteredFaqs.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {filteredFaqs.map((faq, idx) => {
              const catInfo = categoryDetails[faq.categoryGroup] || {
                label: "General",
                color: theme.colors.accent,
          ...
          >
            ...
            <p
              ...
              style={{ color: theme.colors.textSecondary }}
            >
              We couldn't find any guides matching "{searchQuery}". Try using
              different keywords or filter by category group.
            </p>
          </div>
        )}
      </div>
